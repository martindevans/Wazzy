    ...
    : IDisposable
{
    ...
    public readonly Dictionary<string, string> ExtraEnv = [ ];
    ...
    {
        [UsedImplicitly, DataMember(Name = "args")] private string[]? _args;
        [UsedImplicitly, DataMember(Name = "dirs")] private string[]? _dirs;
        [UsedImplicitly, DataMember(Name = "env")] private Dictionary<string, string>? _env = [ ];
        [UsedImplicitly, DataMember(Name = "exit_code")] public int _exitcode;
        [UsedImplicitly, DataMember(Name = "stderr")] public string? _stderr;
        [UsedImplicitly, DataMember(Name = "stdout")] public string? _stdout;
