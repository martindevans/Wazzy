...
/// </summary>
public interface IWasiEnvironment
    : IWasiFeature
{
    /// <summary>
    ...
    /// <returns></returns>
    protected WasiError EnvironGetSizes(Caller caller, out uint argNum, out uint dataLen);
    ...
    /// <returns></returns>
    protected WasiError EnvironGet(Caller caller, ReadonlyPointer<Pointer<uint>> environ, Pointer<byte> environBuffer);
    ...
    /// <returns></returns>
    protected WasiError ArgsGetSizes(Caller caller, out uint argNum, out uint dataLen);
    ...
    /// <returns></returns>
    protected WasiError ArgsGet(Caller caller, ReadonlyPointer<Pointer<uint>> environ, Pointer<byte> environBuffer);
