    ...
    : IWasiFeature
{
    ...
    public abstract PrestatGetResult PrestatGet(Caller caller, FileDescriptor fd, ref Prestat result);
    ...
    /// <returns></returns>
    public abstract PrestatDirNameResult PrestatDirName(Caller caller, FileDescriptor fd, Span<byte> name);
    ...
    /// <returns></returns>
    public abstract PathOpenResult PathOpen(Caller caller, FileDescriptor fd, LookupFlags lookup, ReadOnlySpan<byte> path, OpenFlags openFlags, FileRights baseRights, FileRights inheritingRights, FdFlags fdFlags, ref FileDescriptor outputFd);
    ...
    /// <param name="fd"></param>
    /// <returns></returns>
    public abstract CloseResult Close(Caller caller, FileDescriptor fd);
    ...
    /// <returns></returns>
    public abstract ReadDirectoryResult ReadDirectory(Caller caller, FileDescriptor fd, Span<byte> buffer, long cookie, ref uint bufUsedOutput);
    ...
    /// <returns></returns>
    public abstract WasiError PathCreateDirectory(Caller caller, FileDescriptor fd, ReadOnlySpan<byte> path);
    ...
    /// <returns></returns>
    public abstract WasiError Write(Caller caller, FileDescriptor fd, ReadonlyBuffer<ReadonlyBuffer<byte>> iovs, ref uint nwrittenOutput);
    ...
    /// <returns></returns>
    public abstract WasiError PWrite(Caller caller, FileDescriptor fd, Buffer<Buffer<byte>> iovs, long offset, ref uint nread);
    ...
    /// <returns></returns>
    public abstract StatResult StatGet(Caller caller, FileDescriptor fd, ref FileStat result);
    ...
    /// <returns></returns>
    public abstract WasiError StatSetSize(Caller caller, FileDescriptor fileDescriptor, long size);

    public abstract WasiError FdStatSetTimes(Caller caller, FileDescriptor fileDescriptor, long atime, long mtime, FstFlags fstFlags);
    ...
    /// <returns></returns>
    public abstract WasiError PathFileStatSetTimes(Caller caller, FileDescriptor fileDescriptor, LookupFlags lookup, ReadOnlySpan<byte> path, long atime, long mtime, FstFlags fstFlags);
    ...
    /// <param name="lookup"></param>
    /// <returns></returns>
    public abstract StatResult PathStatGet(Caller caller, FileDescriptor fd, LookupFlags lookup, ReadOnlySpan<byte> path, ref FileStat result);
    ...
    /// <returns></returns>
    public abstract ReadResult Read(Caller caller, FileDescriptor fd, Buffer<Buffer<byte>> iovs, ref uint nread);
    ...
    /// <param name="nread">Output for the total number of bytes read</param>
    /// <returns></returns>
    public abstract ReadResult PRead(Caller caller, FileDescriptor fd, Buffer<Buffer<byte>> iovs, long offset, ref uint nread);
    ...
    /// <returns></returns>
    public abstract SeekResult Seek(Caller caller, FileDescriptor fd, long offset, Whence whence, ref ulong newOffset);
    ...
    /// <param name="fd"></param>
    /// <returns></returns>
    public abstract SyncResult Sync(Caller caller, FileDescriptor fd);
    ...
    public abstract WasiError PathRemoveDirectory(Caller caller, FileDescriptor fd, ReadOnlySpan<byte> path);

    public abstract WasiError PathUnlinkFile(Caller caller, FileDescriptor fd, ReadOnlySpan<byte> path);
    ...
    /// <returns></returns>
    public abstract WasiError PathRename(Caller caller, FileDescriptor fd, ReadOnlySpan<byte> oldPath, FileDescriptor newFd, ReadOnlySpan<byte> newPath);
    ...
    /// <returns></returns>
    public abstract WasiError FdAdvise(Caller caller, FileDescriptor fd, long offset, long filesize, Advice advice);
    ...
    /// <returns></returns>
    public abstract WasiError FdAllocate(Caller caller, FileDescriptor fd, long offset, long length);

    public abstract WasiError FdStatGet(Caller caller, FileDescriptor fd, ref FdStat pointer);

    public abstract WasiError FdStatSetFlags(Caller caller, FileDescriptor fd, FdFlags flags);

    public abstract WasiError ReadLinkAt(Caller caller, FileDescriptor fd, ReadOnlySpan<byte> path, Span<byte> result, ref int nwritten);

    public abstract WasiError PathLink(Caller caller, FileDescriptor sourceRootFd, ReadOnlySpan<byte> sourcePath, int lookupFlags, FileDescriptor destRootFd, ReadOnlySpan<byte> destPath);

    public abstract WasiError PathSymLink(Caller caller, ReadOnlySpan<byte> oldPath, FileDescriptor fileDescriptor, ReadOnlySpan<byte> newPath);
